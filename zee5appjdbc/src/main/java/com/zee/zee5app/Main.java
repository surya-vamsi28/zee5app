...
public class Main {
	...
	public static void main(String[] args) throws IdNotFoundException, InvalidPasswordException, InvalidIdLengthException, InvalidNameException, InvalidEmailException, IOException {
...
//		
		...
		movie.setMovie_id("1");
		movie.setMovie_genre("comedy");
		movie.setMovie_cast("AA");
